...
namespace dk::gm {
	 ...
	 */
	using Default = TemplateGamemode<{Suit::Heart, Value::Ten}, {Value::Queen}, {Value::Jack}, {Suit::Diamond}>;
	/**
	 * @brief In the club solo is the same as the Default gamemode but clubs are tump instead of diamonds.
	 */
	using ClubSolo = TemplateGamemode<{Suit::Heart, Value::Ten}, {Value::Queen}, {Value::Jack}, {Suit::Club}>;
	/**
	 * @brief In the spade solo is the same as the Default gamemode but spades are tump instead of diamonds.
	 */
	using SpadeSolo = TemplateGamemode<{Suit::Heart, Value::Ten}, {Value::Queen}, {Value::Jack}, {Suit::Spade}>;
	/**
	 * @brief In the heart solo is the same as the Default gamemode but hearts are tump instead of diamonds.
	 */
	using HeartSolo = TemplateGamemode<{Suit::Heart, Value::Ten}, {Value::Queen}, {Value::Jack}, {Suit::Heart}>;
	/**
